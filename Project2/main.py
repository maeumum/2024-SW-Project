...
def execute_command_callback(command, car_controller):
    ...
    if command == "ENGINE_BTN":
        ...
        if (car_controller.car._Car__left_door_status == "CLOSED" and
                ...
                car_controller.car._Car__engine_on == True and
                car_controller.car._Car__lock == False and
                car_controller.car._Car__trunk_status == True and
                car_controller.car._Car__speed > 0 and
                car_controller.car._Car__speed < 150):
